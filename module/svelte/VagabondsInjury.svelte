...
<lineage>
	...
	<ol class="items-list">
		...
		<li class="item flexrow item-header">
            ...
            <div class="item-controls">
              <a on:click={sheet?._onItemCreate.bind(sheet)} class="item-control item-create" title="Create item" data-type="injury"><i class="fas fa-plus"></i> Add injury</a>
            </div>
        </li>
	</ol>
</lineage>
